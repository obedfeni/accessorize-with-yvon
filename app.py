...
# FIX: Proper initialization of session state variables
...
if "cart" not in st.session_state:
    st.session_state.cart = []  # FIX: Was incorrectly set to False
if "carousel_indices" not in st.session_state:
    st.session_state.carousel_indices = {}  # FIX: Separate storage for carousel states
...
# ==========================================
# ANIMATED FEMININE THEME - MOBILE FIRST
# ==========================================
...
<style>
    ...
    * {{
    ...
    /* ==========================================
       HEADER - ELEGANT NAVIGATION WITH ANIMATION
       ========================================== */
    .header {{
    ...
    @keyframes gentlePulse {{
        0%, 100% {{ box-shadow: 0 4px 20px {SHADOW_COLOR}; }}
        50% {{ box-shadow: 0 8px 30px rgba(217, 119, 6, 0.3); }}
    }}
    ...
    .brand-name {{
        ...
        background: linear-gradient(135deg, {TEXT_PRIMARY} 0%, {PRIMARY_COLOR} 100%);
    ...
    .product-card:hover {{
        ...
        box-shadow: 0 25px 50px {SHADOW_COLOR};
    ...
    @keyframes priceGlow {{
        ...
        50% {{ text-shadow: 0 0 10px rgba(220, 38, 38, 0.3); }}
    }}
    ...
    /* ==========================================
       BUTTONS - GOLDEN THEME WITH ANIMATIONS
       ========================================== */
    .stButton > button {{
    ...
    .stButton > button:hover {{
        ...
        box-shadow: 0 8px 25px {SHADOW_COLOR} !important;
    }}
    ...
    .admin-btn-container button {{
        ...
        background: linear-gradient(135deg, {TEXT_SECONDARY} 0%, {TEXT_PRIMARY} 100%) !important;
    }}
    
    /* ==========================================
       FORMS - ELEGANT INPUTS WITH ANIMATIONS
       ========================================== */
...
# FIX: Added show_spinner parameter to cache_resource
        ...
        for idx, order in orders_df.iterrows():
            ...
            with st.expander(expander_label):
                ...
                with col2:
                    ...
                    st.markdown(f"""
                        <a href="{wa_url}" target="_blank" style="display:block;background:linear-gradient(135deg,#25D366,#128C7E);color:white;padding:12px;border-radius:10px;text-align:center;text-decoration:none;margin-bottom:12px;font-weight:600;box-shadow:0 4px 15px rgba(37,211,102,0.3);transition:all 0.3s;">
                            📱 WhatsApp
                        </a>
                    """, unsafe_allow_html=True)
